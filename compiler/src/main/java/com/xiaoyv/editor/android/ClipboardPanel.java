        ...
        if (actionMode == null)
            freeScrollingTextField.startActionMode(new ActionMode.Callback() {
                ...
                public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                    actionMode = mode;
                    menu.add(0, 0, 0, context.getString(R.string.editor_select_all))
                            .setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_ALWAYS)
                            .setAlphabeticShortcut('a');

                    menu.add(0, 1, 0, context.getString(R.string.editor_copy))
                            .setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_ALWAYS)
                    ...
                    menu.add(0, 4, 0, context.getString(R.string.editor_cut))
                            .setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_IF_ROOM)
                            .setAlphabeticShortcut('x');

                    menu.add(0, 5, 0, context.getString(R.string.editor_paste))
                            .setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_IF_ROOM)
